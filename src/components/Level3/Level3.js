...
function Level3({ progressToNextLevel }) {
  ...
  const questions = [
    ...
    {
        question: 'Which one is NOT a benefit of Federated Learning?',
        options: ['Enhanced Privacy', 'Reduced Data Transfer', 'Improved Model Accuracy', 'Centralized Data Storage'],
        correctAnswer: 3    
    }     
  ];
